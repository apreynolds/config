...
# Include ~/Documents/3tech/bin, and .local/bin, in $PATH:
export PATH=$HOME/Documents/3tech/bin:$HOME/.local/bin:$PATH
...
ZSH_CUSTOM=$HOME/Documents/3tech/config/zsh-custom
...
export YAZI_CONFIG_HOME=$HOME/Documents/3tech/yazi

# EZA
#export EZA_CONFIG_DIR=$HOME/.config/eza/
export EZA_CONFIG_DIR=$HOME/Documents/3tech/appearance/eza/
...
# Run dircolors:
eval `gdircolors -b ~/Documents/3tech/appearance/dircolors`
